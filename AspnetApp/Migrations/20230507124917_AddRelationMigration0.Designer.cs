...
namespace AspnetApp.Migrations
{
    ...
    [Migration("20230507124917_AddRelationMigration0")]
    partial class AddRelationMigration0
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AspnetApp.Domain.Entities.Questions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AspnetApp.Domain.Entities.Answer", b =>
                {
                    b.HasOne("AspnetApp.Domain.Entities.Questions", null)
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("AspnetApp.Domain.Entities.Questions", b =>
                {
                    b.HasOne("AspnetApp.Domain.Entities.Attachment", "Attachment")
                        .WithMany("Questions")
